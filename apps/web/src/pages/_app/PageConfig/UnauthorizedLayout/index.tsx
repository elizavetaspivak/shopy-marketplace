...
const UnauthorizedLayout: FC<UnauthorizedLayoutProps> = ({children}) => (
    <SimpleGrid bg="#FCFCFC" h='100vh' cols={{base: 2}}>

        <Center component="main" h="100%" w="100%" px={32}>
            {children}
        </Center>

        <Flex bg='#F4F4F4' m={24} style={{borderRadius: '12px'}} my={32}  direction="column" gap='56px' pt={40} px={32} pb={46}>
            ...
            <Box>
                <Title style={{fontSize: 36, fontWeight: 700}}>
                ...
                <Flex align='center' gap={12} mt={32}>
                    ...
                    <Text> <strong>+100</strong> users from all over the world</Text>
                </Flex>
            </Box>
        </Flex>
    </SimpleGrid>
